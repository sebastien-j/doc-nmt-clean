...
def main(job_id, params):
    ...
    validerr = train(saveto=params['model'][0],
                     ...
                     datasets=['data/train.un16.en-es.es.c0.tok.clean.bpe20k.shuf5.1000000', 
                               ...
                               'data/train.un16.en-es.es.ctx.tok.clean.bpe20k.shuf5.1000000'],
                     valid_datasets=['data/devset.un16.en-es.es.c0.tok.clean.bpe20k', 
                                     'data/devset.un16.en-es.en.c0.tok.clean.bpe20k',
                                     'data/devset.un16.en-es.es.ctx.tok.clean.bpe20k',
                     ...
                     other_datasets=['data/train.un16.en-es.es.c0.tok.clean.bpe20k.shuf5.1000', 
                                     ...
                                     'data/train.un16.en-es.es.ctx.tok.clean.bpe20k.shuf5.1000',
                     ...
                     rng=1234,
                     trng=1234,
                     valid_output='output/valid_output.doc',
                     other_output='output/other_output.doc',
                     save_inter=True,
                     encoder='gru',
